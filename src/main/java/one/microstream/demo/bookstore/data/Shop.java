...
public interface Shop extends NamedWithAddress
{
	...
	public Employee randomEmployee(Random random);
	...
	public static class Default extends NamedWithAddress.Abstract implements Shop
	{
		...
		@Override
		public Employee randomEmployee(final Random random)
		{
			return this.employees.get(random.nextInt(this.employees.size()));
		}
